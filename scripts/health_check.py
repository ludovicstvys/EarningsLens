...
def main() -> int:
    ...
    current_text = _load_sample("ACME_Q3_2025.txt")
    prior_text = _load_sample("ACME_Q2_2025.txt")

    current = parse_transcript(current_text, company="ACME", quarter="Q3 2025")
    prior = parse_transcript(prior_text, company="ACME", quarter="Q2 2025")
